<template>
  <div class="background">
    ...
    <div class="maintext">
      ...
      <p class="surline">Last updated: June 15, 2022</p>
      ...
      <ul>
        ...
        <li>
          <p>By visiting this page on my website: <a href="https://www.fabianschuster.net/contact"
              rel="external nofollow noopener" target="_blank">https://www.fabianschuster.net/contact</a></p>
        </li>
      </ul>
    </div>
  </div>
