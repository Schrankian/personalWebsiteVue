<template>
    <div class="background">
        ...
        <div class="maintext">
            ...
            <p class="surline">Last updated: July 22, 2022</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> means the software program provided by the Company downloaded by You
                        on any electronic device, named Debtify - Der Schuldenmanager</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Debtify - Der Schuldenmanager.
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: contact@fabianschuster.net</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="https://www.fabianschuster.net/contact"
                            rel="external nofollow noopener" target="_blank">https://www.fabianschuster.net/contact</a>
                    </p>
                </li>
            </ul>
        </div>
